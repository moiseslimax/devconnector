        ...
        <div className= "container">
            <div className="row">
                <div className="col-md-8 m-auto">
                    ...
                    <p className="lead text-center">Add any school you have had in the past or current</p>
                    ...
                    <div className="form-check mb-4">
                        <input type="checkbox" className="form-check-input" name="current" value={this.state.current} checked={this.state.current}
